...
const player = new Tone.Player("https://s3-us-west-2.amazonaws.com/s.cdpn.io/67732/open-e-down.m4a").connect(dist).sync().start(0);
...
function detectPoseInRealTime(video, net) {
  ...
  eltxt = document.createTextNode('Gapunya gitar gamasalah ada Gitar Melayang 🤘');
  el.appendChild(eltxt);
  document.querySelector("#overlay div").appendChild(el);

  el = document.createElement('p');
  eltxt = document.createTextNode('Cara main Berdiri tegak dan perlihatkan tangan ke webcam, Tangan kiri  untuk atur nada (kunci), Tangan kanan untuk GENJRENG. Have Fun! ');
  el.appendChild(eltxt);
  document.querySelector("#overlay div").appendChild(el);
